...
plt.figure(num=None, figsize=(40, 40), dpi=80, facecolor='w', edgecolor='w')
...
plt.title(label="Correlation Heatmap of All Features", loc='center', fontdict={'fontname':'Arial', 'size':'24', 'color':'black', 'weight':'bold',
